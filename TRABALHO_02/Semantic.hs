...
tExpr envFun env (Const (CInt _)) = return (T_Int, Const (CInt 0)) -- você pode retornar o valor original se quiser
tExpr envFun env (Const (CDouble _)) = return (T_Double, Const (CDouble 0.0))
